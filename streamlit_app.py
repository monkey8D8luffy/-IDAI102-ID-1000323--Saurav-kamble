...
<style>
    ...
    /* --- DROPDOWN & INPUT FIXES (CRITICAL VISIBILITY FIX) --- */
    
    /* 1. The input box itself (where you type) */
    div[data-baseweb="select"] div {
        color: white !important; /* Text color */
        background-color: #262730 !important; /* Dark background */
    }

    /* 2. The dropdown menu (the list of options) */
    ul[data-baseweb="menu"] {
        background-color: #262730 !important;
    }

    /* 3. The text INSIDE the options */
    ul[data-baseweb="menu"] li div, 
    ul[data-baseweb="menu"] li span {
        color: white !important; /* Forces option text to be white */
    }
    ...
    .dry-leaf-burst {
        ...
        animation: fallFast 1.5s linear forwards;
        pointer-events: none;
    ...
    with col_input:
        ...
        with st.container():
            ...
            with st.form("add_item_form_v2", clear_on_submit=False):
                ...
                # FIXED: Ensure the slider line is complete
